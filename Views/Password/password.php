...
<head>
    ...
    <!-- Bootstrap CSS-->
    <link href="<?= media(); ?>/vendor/bootstrap-4.1/bootstrap.min.css" rel="stylesheet" media="all">
    ...
    <!-- Main CSS-->
    <link href="<?= media(); ?>/css/theme.css" rel="stylesheet" media="all">
...
<body class="animsition">
    ...
    <!-- Vendor JS       -->
    <script src="<?= media(); ?>/vendor/slick/slick.min.js">
    </script>
    <script src="<?= media(); ?>/vendor/wow/wow.min.js"></script>
    <script src="<?= media(); ?>/vendor/animsition/animsition.min.js"></script>
    <script src="<?= media(); ?>/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js">
    </script>
    <script src="<?= media(); ?>/vendor/counter-up/jquery.waypoints.min.js"></script>
    <script src="<?= media(); ?>/vendor/counter-up/jquery.counterup.min.js">
    </script>
    ...
    <script src="<?= media(); ?>/vendor/select2/select2.min.js">
    </script>
